...
scrollElement.addEventListener("scroll", function () {
    ...
    roomSize[i].classList.toggle("meeting-rooms__size--hide", scrollElement.scrollLeft > 121);

    for (var j = 0; j < roomTextData.length; j++) {
      roomTextData[j].classList.toggle("meeting-rooms__text-content--mob-scroll", scrollElement.scrollLeft > 121);
    }
